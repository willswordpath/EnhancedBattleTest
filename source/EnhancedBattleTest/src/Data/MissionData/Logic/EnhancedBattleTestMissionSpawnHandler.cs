...
namespace EnhancedBattleTest.Data.MissionData.Logic
{
    public class EnhancedBattleTestMissionSpawnHandler : MissionLogic
    {
        ...
        public override void AfterStart()
        {
            ...
            _missionAgentSpawnLogic.InitWithSinglePhase(ofHealthyMembers1, ofHealthyMembers2, defenderInitialSpawn, attackerInitialSpawn, true, true, new MissionSpawnSettings());
        }
    }
}
